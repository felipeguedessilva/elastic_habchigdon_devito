...
# Weights
#==============================================================================
pesos                  = Function(name='pesos', grid=grid, space_order=2)
pesos.data[:]          = MVT[:]
#==============================================================================
...
beta  = (1+(FTEST[x,y,z]/FTEST[x,y,z]))/(2)

ax    =  hx + (dt/beta)*FTEST[x,y,z]
bx    =  hx - (dt/beta)*FTEST[x,y,z]
cx    =  hx + (dt/beta)*FTEST[x,y,z]
dx    = -hx + (dt/beta)*FTEST[x,y,z]

ay    =  hy + (dt/beta)*FTEST[x,y,z]
by    =  hy - (dt/beta)*FTEST[x,y,z]
cy    =  hy + (dt/beta)*FTEST[x,y,z]
dy    = -hy + (dt/beta)*FTEST[x,y,z]

az    =  hz + (dt/beta)*FTEST[x,y,z]
bz    =  hz - (dt/beta)*FTEST[x,y,z]
cz    =  hz + (dt/beta)*FTEST[x,y,z]
dz    = -hz + (dt/beta)*FTEST[x,y,z]
...
for i in range(0,3):
    ...
    if(i==0): vpesos = pesos[x,y,z]
    if(i==1): vpesos = pesos[x,y,z]
    if(i==2): vpesos = pesos[x,y,z]
